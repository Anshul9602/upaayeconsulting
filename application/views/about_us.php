...
<section class="p-0">
    <div class="row">
        <div class="col-md-6 p-5" style="background:  linear-gradient(to right, #0A1B2D, #5c7997);">
            <div class="container" style="color: #fff;">
                <h2 class="text-9 line-height-3 text-transform-none font-weight-semibold mb-4 text-center">Value</h2>
                <p class="text-center" >
                Integrity, Accuracy, Client-Centric Approach, Continuous Improvement.
                </p>
            </div>
        </div>
        <div class="col-md-6 p-5" style="background-color: #5ba4cf;">
            <div class="container"style="color:#fff;">
                <h2 class="text-9 line-height-3 text-transform-none font-weight-semibold mb-4 text-center">Experiences </h2>
                <p class="text-center">
                With a combined experience of over 10 years in the industry, ADLedger Services has successfully assisted numerous businesses in optimizing their financial processes and maintaining robust accounting systems
                </p>
            </div>
        </div>
        <div class="col-md-6 p-5 order-2 order-md-1" style="background-color:  #5ba4cf;">
            <div class="container"style="color:#fff;">
                <h2 class="text-9 line-height-3 text-transform-none font-weight-semibold mb-4 text-center">Mission</h2>
                <p class="text-center">
                    Providing accurate, timely, and secure accounting solutions tailored to our clients' unique needs.
                </p>
            </div>
        </div>
        <div class="col-md-6 p-5 order-1 order-md-2" style="background:  linear-gradient(to right, #5c7997, #0A1B2D );">
            <div class="container" style="color:#fff;">
                <h2 class="text-9 line-height-3 text-transform-none font-weight-semibold mb-4 text-center">Vision </h2>
                <p class="text-center">
    ...
    <div class="container">
        <div class="row m-0" style="justify-content: space-around;">
            ...
            <div class="col-md-3   text-center card1 m-3">
                <img src="assets/img/blog/ab1.jpg" alt="" width="100%">
                <h5 class="text-center mt-4" style="font-weight:600;">Col RS Samar (Retd)
                </h5>
            ...
            <div class="col-md-3   text-center card1 m-3">
                ...
                <div class="cont1 mt-4">
                    <p class="text-start">I am Rakesh Sharma, a dedicated professional with a strong educational background, holding a
                        ...
                        Currently serving as the Director at Adledger Services Pvt Ltd., I bring over 15 years of
                        invaluable
            ...
            <div class="col-md-3   text-center card1 m-3">
                ...
                <h5 class="text-center mt-4" style="font-weight:600;">Rohit Pareek
                </h5>
                <p class="text-center"> (Director)</p>
                ...
                <div class="cont2 mt-4">
                    ...
                    <p class="text-start"> Specializing in budgeting, forecasting, and audit compliance, I foster team collaboration and
                        ...
                        reflects
                        dedication to navigating complexities. Excited to contribute to Adledger's financial growth and
...
<section class="desk" style="background-color: gainsboro;">
    <div class="container">
        <div class="row" style="justify-content: space-around;">
            ...
            <div class="col-md-12   text-center card1 row">
                <div class="col-md-4">
                    <img src="assets/img/blog/ab1.jpg" alt="" width="100%">
                </div>
                <div class=" col-md-8" style="    display: grid;    align-items: center;">
                    <div>
                        <h5 class="text-center mt-4" style="font-weight:600;">Col RS Samar (Retd)
                        </h5>
                        <p class="text-center"> (CEO)</p>
                        ...
                        <p class="text-start"> Col RS Samar's diverse and rich experience spans administration, human resource management,
                            ...
                            academic qualifications include a graduate degree in science, specializing in microwave
                            electronics,
                            and postgraduate diplomas in HR and Labour laws & Labour welfare. As effective team leaders,
                            the
                            management is committed to carry the team together to achieve tasks efficiently and
                            effectively.
                        </p>
                    </div>
                </div>
            ...
            <div class="col-md-12 row   text-center card1 mt-4 justify-content-center align-content-center">

                <div class="col-md-8 " style="    display: grid;    align-items: center;">

                    <div>
                        <h5 class="text-center " style="font-weight:600;">Rakesh Sharma
                        </h5>
                        <p class="text-center"> (Director)</p>
                        ...
                        <p class="text-start">I am Rakesh Sharma, a dedicated professional with a strong educational background, holding a
                            ...
                            Currently serving as the Director at Adledger Services Pvt Ltd., I bring over 15 years of
                            invaluable
                            experience in the field of accounting, Finance, Costing taxation, Auditing Accounting
                            Software
                            Tally, QuickBooks, SAP.</p>
                    </div>
            ...
            <div class="col-md-12 row   text-center card1 mt-4">
                <div class="col-md-4">
                    <img src="assets/img/blog/ab3.jpg" alt="" width="100%">
                </div>
                <div class="col-md-8" style="display: grid;align-items: center;">
...
<script>
    document.addEventListener("DOMContentLoaded", function () {
        ...
        var moreLink1 = document.getElementById('more1');
        var contDiv1 = document.querySelector('.cont1');

        moreLink1.addEventListener('click', function (event) {
            // Prevent the default behavior of the anchor tag #}
            contDiv1.style.display = contDiv1.style.display === 'block' ? 'none' : 'block';

        });
        var moreLink2 = document.getElementById('more2');
        var contDiv2 = document.querySelector('.cont2');

        moreLink2.addEventListener('click', function (event) {
            // Prevent the default behavior of the anchor tag #}
            contDiv2.style.display = contDiv2.style.display === 'block' ? 'none' : 'block';
